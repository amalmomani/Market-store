...
namespace Market_store.Controllers
{
    public class MainpagesController : Controller
    {
        ...
        public MainpagesController(ModelContext context, IWebHostEnvironment _webHostEnvironment)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("Homeid,Companylogo,Image1,Image2,Text1,Text2,Companyemail,Companyphone")] Mainpage mainpage)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Homeid,Companylogo,Image1,Image2,Text1,Text2,Companyemail,Companyphone, ImageFile")] Mainpage mainpage)
        {
